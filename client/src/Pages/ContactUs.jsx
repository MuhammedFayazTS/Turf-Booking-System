        ...
        <div className="mx-auto max-w-7xl py-12 md:py-24">
          <div className="grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2">
            ...
            <div className="flex items-center justify-center">
              <div className="px-2 md:px-12">
                ...
                <form action="" className="mt-8 space-y-4">
                  ...
                  <button
                    type="button"
                    className="w-full rounded-md bg-green-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                  >
                    Send Message
                  </button>
                </form>
            ...
            <img
              ...
              src="https://images.unsplash.com/photo-1603714228681-b399854b8f80?q=80&w=2060&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            />
          </div>
        </div>
      </div>
